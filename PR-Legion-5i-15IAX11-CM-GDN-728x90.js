...
lib.ssMetadata = [
		{name:"PR_Legion_5i_15IAX11_CM_GDN_728x90_atlas_1", frames: [[730,0,50,50],[0,0,728,90],[0,92,728,90],[0,184,728,90],[0,276,728,90],[0,368,728,90],[0,460,728,90],[0,552,728,90]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_Legion_5i_15IAX11_CM_GDN_728x90_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRLegion5i15IAX11CMGDN728x90 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(300).to({_off:false},0).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(250).to({_off:false},0).to({_off:true},50).wait(30));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(200).to({_off:false},0).to({_off:true},50).wait(80));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(150).to({_off:false},0).to({_off:true},50).wait(130));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(100).to({_off:false},0).to({_off:true},50).wait(180));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(50).to({_off:false},0).to({_off:true},50).wait(230));
...
// library properties:
lib.properties = {
	id: 'C065385E5E405546A223D301284F9A12',
	width: 728,
	height: 90,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_Legion_5i_15IAX11_CM_GDN_728x90_atlas_1.png", id:"PR_Legion_5i_15IAX11_CM_GDN_728x90_atlas_1"}
	],
	preloads: []
};
...
an.compositions['C065385E5E405546A223D301284F9A12'] = {
